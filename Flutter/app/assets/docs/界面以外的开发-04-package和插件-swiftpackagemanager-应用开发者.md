...
> 官方文档：[针对应用开发者](https://docs.flutter.cn/packages-and-plugins/swift-package-manager/for-app-developers)
> 内容来源：github (`packages-and-plugins/swift-package-manager/for-app-developers.md`)
> 抓取时间：2026-07-10
...
一般情况下，请不要这样做。请记住，
CocoaPods registry 将于 2026 年 12 月 2 日变为只读，
今后将不再允许禁用 SwiftPM。
