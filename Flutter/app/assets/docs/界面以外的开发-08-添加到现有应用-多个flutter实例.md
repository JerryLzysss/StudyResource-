...
> 官方文档：[多个 Flutter 实例](https://docs.flutter.cn/add-to-app/multiple-flutters)
> 内容来源：github (`add-to-app/multiple-flutters.md`)
> 抓取时间：2026-07-10
...
description: 如何将多个 Flutter 引擎 (engine)、页面 (screen) 或视图 (view) 添加到你的应用中。
---
