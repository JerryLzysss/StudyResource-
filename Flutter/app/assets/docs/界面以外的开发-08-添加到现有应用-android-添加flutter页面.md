...
> 官方文档：[添加单个 Flutter 页面](https://docs.flutter.cn/add-to-app/android/add-flutter-screen)
> 内容来源：github (`add-to-app/android/add-flutter-screen.md`)
> 抓取时间：2026-07-10
