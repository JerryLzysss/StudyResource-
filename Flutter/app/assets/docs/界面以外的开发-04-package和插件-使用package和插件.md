...
> 官方文档：[使用 package 和插件](https://docs.flutter.cn/packages-and-plugins/using-packages)
> 内容来源：github (`packages-and-plugins/using-packages.md`)
> 抓取时间：2026-07-10
...
title: 在 Flutter 里使用 Package
# description: How to use packages in your Flutter app.
description: 如何在你的 Flutter 应用里使用 Package。
tags: Package,插件
