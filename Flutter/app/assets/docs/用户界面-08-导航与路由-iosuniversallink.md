...
> 官方文档：[设置 iOS Universal Link](https://docs.flutter.cn/cookbook/navigation/set-up-universal-links)
> 内容来源：github (`cookbook/navigation/set-up-universal-links.md`)
> 抓取时间：2026-07-10
...
**universal link** 是一种仅适用于 iOS 设备的深度链接类型，
只使用 `http` 或 `https` 协议。
...
你可以在 GitHub 仓库中找到 [deeplink_cookbook 示例][deeplink_cookbook] 实用教程的源代码。
