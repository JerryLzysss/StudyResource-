...
> 官方文档：[配置 Web 开发](https://docs.flutter.cn/platform-integration/web/setup)
> 内容来源：github (`platform-integration/web/setup.md`)
> 抓取时间：2026-07-10
...
要在 Web 上运行和调试 Flutter 应用，请 [下载并安装 Google Chrome][chrome-install]，
或 [安装并使用 Microsoft Edge][edge-install]。

<details>
<summary><t>Expand for instructions for other browsers</t><t>展开以查看其他浏览器的说明</t></summary>
...
若要在其他 Web 浏览器中调试应用，可使用 `flutter run -d web-server` 命令，
并在你偏好的浏览器中手动打开指定 URL。
...
你已为 Flutter 配置好 Web 开发，
可以在 Web 上测试的同时继续学习 Flutter，或开始扩展与 Web 的集成。
