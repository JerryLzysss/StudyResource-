...
> 官方文档：[添加一个 Flutter Fragment](https://docs.flutter.cn/add-to-app/android/add-flutter-fragment)
> 内容来源：github (`add-to-app/android/add-flutter-fragment.md`)
> 抓取时间：2026-07-10
...
shortTitle: 添加 Flutter Fragment
