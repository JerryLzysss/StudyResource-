...
> 官方文档：[Android 工程设定](https://docs.flutter.cn/add-to-app/android/project-setup)
> 内容来源：github (`add-to-app/android/project-setup.md`)
> 抓取时间：2026-07-10
...
在同一应用层级的 build.gradle 文件末尾添加自定义 `profileImplementation` 依赖项。
