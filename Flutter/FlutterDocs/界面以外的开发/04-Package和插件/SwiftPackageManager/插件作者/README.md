...
> 官方文档：[针对插件作者](https://docs.flutter.cn/packages-and-plugins/swift-package-manager/for-plugin-authors)
> 内容来源：github (`packages-and-plugins/swift-package-manager/for-plugin-authors.md`)
> 抓取时间：2026-07-10
