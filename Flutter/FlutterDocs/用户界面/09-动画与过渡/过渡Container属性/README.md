...
> 官方文档：[过渡 Container 的属性](https://docs.flutter.cn/cookbook/animation/animated-container)
> 内容来源：github (`cookbook/animation/animated-container.md`)
> 抓取时间：2026-07-10
...
<noscript>
  <img src="/assets/images/docs/cookbook/animated-container.webp" alt="这个 AnimatedContainer demo 展示了一个通过动画改变颜色、边框半径、放大和缩小的盒子" class="site-mobile-screenshot" />
</noscript>
